...
bool BQ76952::sendCommandSubcommand(BQ769X2_PROTOCOL::Cmd command,  TickType_t timeout) {
    return BQ769X2_PROTOCOL::sendCommandSubcommand(*i2c_controller, i2c_addr, command, timeout);
}

bool BQ76952::sendSubcommandR(Cmd cmd, uint8_t readOut[32], TickType_t timeout) {
    return BQ769X2_PROTOCOL::sendSubcommandR(*i2c_controller, i2c_addr, cmd, readOut, timeout);
}

bool BQ76952::sendSubcommandW(Cmd cmd, uint8_t data, TickType_t timeout) {
    return BQ769X2_PROTOCOL::sendSubcommandW(*i2c_controller, i2c_addr, cmd, data, timeout);
}

bool BQ76952::sendSubcommandW2(Cmd cmd,uint16_t data, TickType_t timeout) {
    return BQ769X2_PROTOCOL::sendSubcommandW2(*i2c_controller, i2c_addr, cmd, data, timeout);
}

bool BQ76952::sendDirectCommandR(CmdDrt command, uint16_t * readOut, TickType_t timeout) {
    return BQ769X2_PROTOCOL::sendDirectCommandR(*i2c_controller, i2c_addr, command, readOut, timeout);
}

bool BQ76952::sendDirectCommandW(CmdDrt command, uint16_t data, TickType_t timeout) {
    return BQ769X2_PROTOCOL::sendDirectCommandW(*i2c_controller, i2c_addr, command, data, timeout);
}

bool BQ76952::setRegister(RegAddr reg_addr, uint32_t reg_data, uint8_t datalen, TickType_t timeout) {
