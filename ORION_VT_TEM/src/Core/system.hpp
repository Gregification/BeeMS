...
#define PROJECT_NAME            "CAN bus Ethernet transceiver"
...
#define TASK_NOTIFICATION_ARRAY_INDEX_FOR_SYSTEM_ADC_IRQ 3
...
#define PROJECT_ENABLE_ADC0
#define PROJECT_ENABLE_ADC1
...
namespace System {
    ...
    namespace ADC {
        constexpr uint32_t ADC_IRQ_MEM_MASK =
                DL_ADC12_INTERRUPT_MEM0_RESULT_LOADED | DL_ADC12_INTERRUPT_MEM1_RESULT_LOADED | DL_ADC12_INTERRUPT_MEM2_RESULT_LOADED
              | DL_ADC12_INTERRUPT_MEM3_RESULT_LOADED | DL_ADC12_INTERRUPT_MEM5_RESULT_LOADED | DL_ADC12_INTERRUPT_MEM6_RESULT_LOADED
              | DL_ADC12_INTERRUPT_MEM7_RESULT_LOADED | DL_ADC12_INTERRUPT_MEM8_RESULT_LOADED | DL_ADC12_INTERRUPT_MEM9_RESULT_LOADED
              | DL_ADC12_INTERRUPT_MEM10_RESULT_LOADED | DL_ADC12_INTERRUPT_MEM11_RESULT_LOADED;

        struct ADC : Lockable{
            ADC12_Regs * const adc;
    ...
    namespace CANFD {
        ...
        const uint32_t getCANID(DL_MCAN_RxBufElement const *);
        const uint32_t getCANID(DL_MCAN_TxBufElement const *);
    }
